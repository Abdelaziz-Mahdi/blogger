...
RSpec.describe Post, type: :model do
  ...
  it 'last_five_comments should return five most recent comments' do
    ...
    Comment.create(text: 'Comment 1', post:)
    Comment.create(text: 'Comment 2', post:)
    Comment.create(text: 'Comment 3', post:)
    Comment.create(text: 'Comment 4', post:)
    Comment.create(text: 'Comment 5', post:)
    Comment.create(text: 'Comment 6', post:)
